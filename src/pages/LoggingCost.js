      ...
      <div className="siem-ingestion-volume-by-parent">
                  ...
                  <div className="container2">
                    <div className="menuitembasicslot">
                      ...
                      <div className="container3">
                        <div className="value1">Azure</div>
                ...
                <div className="menuitem">
                  <div className="container2">
                    <div className="menuitembasicslot">
                      ...
                      <div className="container3">
                        <div className="value1">OpsManager</div>
                        <div className="right-content">
                          <div className="typography2">⌘X</div>
                        </div>
                      </div>
                ...
                <div className="menuitem">
                  <div className="container6">
                    <div className="menuitembasicslot">
                      ...
                      <div className="container3">
                        <div className="value1">Linux</div>
                        <div className="right-content">
                          <div className="typography2">⌘X</div>
                        </div>
                      </div>
        ...
        <div className="rectangle-group">
          ...
          <div className="vector-parent">
            ...
            <img className="group-child15" alt="" src="../rectangle-21.svg" />
            <img className="group-child16" alt="" src="../rectangle-22.svg" />
            <b className="azure1">Azure</b>
            <b className="opsmanager">OpsManager</b>
            <b className="linux">Linux</b>
          </div>
          ...
          <div className="gb11">0 GB</div>
          <div className="gb12">35 GB</div>
          <div className="switch-wrapper">
            <div className="switch">
              <div className="value1">Detailed View</div>
